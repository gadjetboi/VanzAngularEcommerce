...
var ReviewComponent = (function () {
    function ReviewComponent(orderService, cartService, store) {
        this.orderService = orderService;
        this.cartService = cartService;
        this.store = store;
        this.orderItems = new Array();
...
var OrderService = (function () {
    ...
    OrderService.prototype.removeNavigatableTab = function (tabName) {
        var navigatableIndex = this.navigatableTabs.findIndex(function (navigatableTab) {
            return tabName === navigatableTab;
        });
